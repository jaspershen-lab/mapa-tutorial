...
+===================+===========================================+==================+
| `circular_plot`   | Circular vs. horizontal layout            | Not ticked       |
+-------------------+-------------------------------------------+------------------+
| `Module ID`       | Specific modules to show                  | `NULL`           |
+-------------------+-------------------------------------------+------------------+
| `Levels Included` | The extent of details to show on the plot | All ticked       |
+-------------------+-------------------------------------------+------------------+
| `Position Limits` | Determine how dense the node is arranged  | `[0, 1]` for all |
+-------------------+-------------------------------------------+------------------+
