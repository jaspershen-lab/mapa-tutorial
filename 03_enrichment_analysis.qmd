...
The enrichment results object is tailored for downstream similarity analysis and module identification in MAPA, so it cannot be substituted with outputs from other tools. Make sure you complete the steps above before proceeding.
