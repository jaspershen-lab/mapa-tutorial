...
### Get Our Example Toy Data

MAPA provides several **built-in demo datasets** that help you to go through and study MAPA workflow steps such as pathway enrichment analysis, and integrated expression visualization.
...
Below are some info about these datasets:
...
| ```            |                                                                          |         |         |                                          |                                                                                    |
+----------------+--------------------------------------------------------------------------+---------+---------+------------------------------------------+------------------------------------------------------------------------------------+
| ```            | 5,290 proteins with fold changes and adjusted p-values from liver tissue | 5,290   | 3       | Gene Gene Set Enrichment Analysis (GSEA) | Takasugi et al., *Nat Commun* **15**, 8520 (2024), DOI: 10.1038/s41467-024-52845-x |
| demo_data_gsea |                                                                          |         |         |                                          |                                                                                    |
| ```            |                                                                          |         |         |                                          |                                                                                    |
+----------------+--------------------------------------------------------------------------+---------+---------+------------------------------------------+------------------------------------------------------------------------------------+
