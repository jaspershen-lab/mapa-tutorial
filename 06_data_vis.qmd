...
::: {layout="[40, 30, 30]"}
![](images/network_go_25.png){width="242"} ![](images/barplot_go_25.png){width="197"} ![](images/wordcloud_go_25.png){width="198"}
:::
...
1.  **Empty plots or warnings about no data**
