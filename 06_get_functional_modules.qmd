...
For **GSEA results**, additional columns include:
- **NES**: Normalized Enrichment Score of the representative pathway
- **core_enrichment**: Core enriched genes contributing to the module
