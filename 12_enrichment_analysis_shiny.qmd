# Pathway Analysis {#sec-enrichment_analysis_shiny}
...
::: callout-note
**GSEA Requirements**: If you select GSEA, an additional "Order by" field will appear. This should correspond to a numeric column in your data (like fold change or p-values) that will be used to rank genes. Make sure **this column named "fc" or "p_value_adjust"**.
:::
