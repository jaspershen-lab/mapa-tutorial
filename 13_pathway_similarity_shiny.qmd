...
-   For SilisonFlow: Get your API key from [SiliconFlow Website](https://docs.siliconflow.com/en/userguide/quickstart)
...
When running the *biotext embedding* step in this chapter or the *module annotation* step in @sec-shiny_llm_interpretation_shiny, **only models and API keys provided by [SiliconFlow](https://www.siliconflow.com/)** are supported.\
