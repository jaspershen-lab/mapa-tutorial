...
-   **GO terms**: Semantic similarity using the [simona](https://jokergoo.github.io/simona/) package
-   **KEGG/Reactome/SMPDB pathways**: Gene/metabolite overlap similarity (Jaccard, Dice, Overlap, and Kappa)
