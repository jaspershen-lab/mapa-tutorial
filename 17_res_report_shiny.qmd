...
-   **Option 2: Upload Existing Results**
    ...
    1.  **Click "Browse"** at the top of the left panel (of _Data Visualization function_ page) **"Upload functional module (.rda)"** to upload your functional module file (.rda format)
    2.  **Select your file**
    3.  **Wait for validation** - the app will automatically detect the input type and prepare for final report.
    4.  **Switch back to _Results & Report_ page**
...
The MAPA Shiny app workflow is now complete! Thank you for your usage. If you have any questions, feel free to reach out via the [MAPA GitHub Issues page](https://github.com/jaspershen-lab/mapa-tutorial/issues).
